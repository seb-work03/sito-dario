    ...
    <section className="bg-[#0D1218] px-5 py-14">
      <div className="mx-auto max-w-[1240px] flex flex-col md:flex-row md:items-center gap-6 md:gap-12">
        ...
        <div className="flex-1 overflow-hidden relative">
          ...
          <div className="flex items-center gap-7 md:gap-20 w-max animate-[refmarquee_18s_linear_infinite] md:animate-[refmarquee_28s_linear_infinite] hover:[animation-play-state:paused]">
            {doubled.map((logo, i) => (
              <div
                key={i}
