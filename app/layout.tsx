...
export const metadata: Metadata = {
  ...
  category: "E-commerce",
  icons: {
    icon: [{ url: "/favicon-dario-tana-ok-1.png", type: "image/png" }],
    shortcut: [{ url: "/favicon-dario-tana-ok-1.png", type: "image/png" }],
    apple: [{ url: "/favicon-dario-tana-ok-1.png", type: "image/png" }],
  },
  openGraph: {
    type: "website",
    locale: "it_IT",
